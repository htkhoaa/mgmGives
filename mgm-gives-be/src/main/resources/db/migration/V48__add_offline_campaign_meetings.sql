ALTER TABLE campaign_meetings
    ADD COLUMN IF NOT EXISTS meeting_type VARCHAR(20) NOT NULL DEFAULT 'ONLINE';

ALTER TABLE campaign_meetings
    ADD COLUMN IF NOT EXISTS location TEXT;

ALTER TABLE campaign_meetings
    ADD COLUMN IF NOT EXISTS calendar_uid VARCHAR(255);
...
CREATE UNIQUE INDEX IF NOT EXISTS ux_campaign_meetings_calendar_uid ON campaign_meetings (calendar_uid);
